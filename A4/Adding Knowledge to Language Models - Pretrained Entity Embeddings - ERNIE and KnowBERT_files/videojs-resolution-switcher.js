...
(function() {
  ...
  (function(window, videojs) {
    ...
    var ResolutionMenuButton = videojs.extend(MenuButton, {
      constructor: function(player, options){
        ...
        if(options.dynamicLabel){
          this.el().querySelector('button .vjs-icon-placeholder').remove();
          this.el().querySelector('button .vjs-control-text').classList.add('show');
        }
    ...
    ResolutionMenuButton.prototype.update = function(){
      ...
      this.controlText(this.currentSelection ? this.currentSelection.label : '');
    ...
    videoJsResolutionSwitcher = function(options) {
      ...
      function initResolutionForYt(player){
        ...
        if(!hls) { return; }
          ...
          let defaultRes = settings.default && 
          player.tech_.hls.representations().find((rep)=>rep.height === parseInt(settings.default));

          var chosen = defaultRes ?
          {
            label: settings.default, 
						res: settings.default, 
						sources: player.groupedSrc.label[settings.default]
          }
          :
          {
						label: 'auto', 
